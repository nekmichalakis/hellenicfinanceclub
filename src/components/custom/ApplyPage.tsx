  ...
  return (
    <div>
      <div className={"bg-primary"}>
        <div
          className={
            "max-w-5xl mx-auto pb-24 pt-40 px-4 sm:px-6 lg:px-8 flex gap-16 items-center"
          }
        >
      ...
      <div className="flex gap-16 bg-primary px-16 py-24 items-center text-white text-center">
        ...
        <div className="w-2/3 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <p className="text-md font-thin">Competitive Academic Track Record</p>
        </div>
      </div>
      <div className={"bg-chart-2 pb-24 pt-40"}>
